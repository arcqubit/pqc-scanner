...
fn print_usage(program: &str) {
    eprintln!("PDQ Scanner - Quantum-Safe Cryptography Auditor");
    eprintln!();
...
fn scan_dir_recursive(
    ...
    critical: &mut usize,
    high: &mut usize,
    results: &mut Vec<pdq_scanner::AuditResult>,
) -> Result<(), String> {
...
fn scan_file(path: &Path) -> Result<Option<pdq_scanner::AuditResult>, String> {
